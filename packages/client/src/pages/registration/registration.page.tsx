...
export const RegistrationPage = () => {
    ...
    const onSubmit = (values: IRegistrationInit, helpers: FormikHelpers<IRegistrationInit>) => {
        AuthServices.registation(values.email, values.password).then((r) => {
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Grid container xs={12} justifyContent="space-between">
                                        ...
                                        <Button variant="contained" type="submit" disabled={isSubmitting || !!(errors.email && touched.email) || !!(errors.password && touched.password)}>
                                            Registration
                                        </Button>
                                    </Grid>
                                </Grid>
